...
def get_args_parser(parser=None):
    ...
    # elif parser is not None: assert hasattr(parser, '--use_llm'), parser
    # Dataset
...
def Get_Merged_Args(opt):
    merged_dict = {**vars(opt), **vars(args)}
    merged_args = Arg_Merge(**merged_dict)
    return merged_args

if __name__ == '__main__':
    args = get_args_parser(parser=None)